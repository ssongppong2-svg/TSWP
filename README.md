...
1. Unity에서 이 프로젝트를 연다
2. 상단 메뉴 **TSWP → 테스트 씬 만들기**
3. **▶ 재생** 버튼
...
빨간 허수아비를 때리면 체력이 깎이고, 쓰러진 뒤 3초면 부활해 반복 테스트할 수 있다.

> 이 씬은 조작감 확인용 임시 구성이다. 캐릭터·맵 디자인, 보스 기믹, 공격 설정이
> 확정되면 실제 데이터(ScriptableObject)와 프리팹으로 교체한다.
